...
- (void)updateSizesAndSpacings {
    ...
    CGFloat kioskLabelAdditionalSpacing = PUBIsiPad() ? 22.0f : 18.0f;
    self.minimumLineSpacing = (PUBIsiPad() ? 31.0f : 51.0f) + (PUBConfig.sharedConfig.showLabelsBelowIssuesInKiosk ? kioskLabelAdditionalSpacing : 0);
